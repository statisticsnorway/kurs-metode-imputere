...
#Datasett er basert pÃ¥ Tabell 8.3 fra L.Lohr "Sampling Design and Analysis" bok
#Task1.1----
...
#!tips: Det er mulig aa kjøre summary() og plot alder vs aar_utdanning eller validator() og confront() fra pakke validate 
...
#Der aar_utdanning var større enn alder (fra Task1.1.d) sett NA verdi
...
#Task2.2----
#Bruk samme datasett som i Øvelser 1, Task 4. Bruk naermest nabo hotdeck imputering for variabel kriminalitetsoffer og voldskriminalitetsoffer.
#Bruk alder og kjønn som hjelpevariabler(forklaringvariabler) for å beregne avstand
...
#Bruk alder og kjønn som hjelpevariabler(forklaringvariabler)
...
#d.finn steget der endringen i totalen av aar_utdaning ble den stÃ¸rste